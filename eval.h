...
// PeSTO tables (Ronald Friederich, RofChade/PeSTO) — a8-first orientation.
// Lookup: WHITE -> table[sq ^ 56], BLACK -> table[sq]  (a1=0 mapping)

inline constexpr int mg_value[6] = { 82, 337, 365, 477, 1025, 0 };
inline constexpr int eg_value[6] = { 94, 281, 297, 512,  936, 0 };
inline constexpr int game_phase_inc[6] = { 0, 1, 1, 2, 4, 0 };

inline constexpr int mg_table[6][64] = {
{ // pawn
   0,   0,   0,   0,   0,   0,   0,   0,
...
inline constexpr int eg_table[6][64] = {
{ // pawn
   0,   0,   0,   0,   0,   0,   0,   0,
